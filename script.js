...
const baseLanes = [
    ...
    { y: 1 * tileSize, type: 'road', direction: 'left', baseSpeed: 1.5 }, // A good starting speed
    { y: 2 * tileSize, type: 'road', direction: 'right', baseSpeed: 1.2 }, // Slightly slower
    { y: 3 * tileSize, type: 'safe', color: '#7CFC00' }, // Safe Zone (Lawn Green)
    { y: 4 * tileSize, type: 'road', direction: 'left', baseSpeed: 1.3 }, // Similar to previous
    { y: 5 * tileSize, type: 'road', direction: 'right', baseSpeed: 1.7 }, // A bit faster
    { y: 6 * tileSize, type: 'safe', color: '#A9A9A9' }, // Safe Zone (Dark Gray)
    { y: 7 * tileSize, type: 'road', direction: 'left', baseSpeed: 1.0 }, // Slowest lane for a breather
    { y: 8 * tileSize, type: 'road', direction: 'right', baseSpeed: 1.8 }, // Fastest initial lane
